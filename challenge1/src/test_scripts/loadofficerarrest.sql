...
COPY data_officerarrest FROM '/Users/blaine/dev/ds/cpdp-wise-lobsters/challenge1/src/data/data_officerarrest.csv'
...
UPDATE data_officerarrest SET arrest_id_=NULL WHERE arrest_id = '';
