...
ORDER BY category, year, COUNT(officer_id) DESC) TO '/Users/blaine/dev/ds/cpdp-wise-lobsters/cp2/src/data/first_by_cat.csv' DELIMITER ',' CSV HEADER;
